...
// css
import "../../Assets/scss/Components/_button.css";
...
const buttons = (props) => {
    ...
    const style = {
        ...
        "text-color": typeof (props.themeColor) === "object" ? `linear-gradient(to right, ${textcolor1}. ${textcolor2}, ${textcolor1})`: props.color,
    }
    return (
        (props.href || props.types === "submit") ? (
            <Button
             as={prop.href ? "a" : (props.type === "submit" ? "button" : "a")}
